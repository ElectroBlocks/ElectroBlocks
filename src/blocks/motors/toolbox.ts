...
<category name="Motor" colour="${COLOR_THEME.COMPONENTS}">
   <block type="move_motor">
    <comment pinned="false" h="180" w="460">The motor number is on your motor shield.  The speed determines how much electricity will flow through your motor.  Depending on how big your motor is will decide on your actual speed.
