...
export default `<category name="Digital" colour="${COLOR_THEME.SENSOR}">
       <block type="digital_read_setup">
            <comment pinned="false" h="171" w="460">This block (digital read setup) tells the Arduino which pin is sense electricity.${whatIsAPin}${virtualCircuitComment}</comment>
       </block>
