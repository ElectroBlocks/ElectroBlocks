...
<category name="Analog" colour="${COLOR_THEME.SENSOR}" >
       <block type="analog_read_setup">
            <comment pinned="false" h="180" w="501">This block (analog read setup) tells the Arduino which pin is sense electricity.${whatIsAPin}${virtualCircuitComment}</comment>
        </block>
