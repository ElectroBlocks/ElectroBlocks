...
<category name="Temp" colour="${COLOR_THEME.SENSOR}"  >
         ...
         <comment pinned="false" h="120" w="460">This sensor will read the temperature in Celius and the humidity.  Be sure to specify the sensor type.${virtualCircuitComment}</comment>
         </block>
