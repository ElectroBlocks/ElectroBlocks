...
<block type="button_setup">
      <comment pinned="false" h="171" w="460">This block (Bluetooth setup block) tells the Arduino we are using Bluetooth devices.${whatIsAPin}${virtualCircuitComment}</comment>
</block>
