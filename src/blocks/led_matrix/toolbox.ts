...
export default `<category colour="${COLOR_THEME.COMPONENTS}" name="Led Matrix">
    ...
    <comment pinned="false" h="60" w="460">This block sets up the let matrix.  You can use any digital pins you want.</comment>
     ...
     <block type="led_matrix_make_draw">
        <comment pinned="false" h="60" w="460">Check the checkboxes to draw a pattern on the led matrix.</comment>
     </block>
   <block type="led_matrix_turn_one_on_off">
   <comment pinned="false" h="120" w="460" >Turns or off one led on the led matrix.  
