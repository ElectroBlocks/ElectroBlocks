 ...
 */
const registerListMenu = (workspace) => {
    workspace.registerToolboxCategoryCallback('LIST', () => {
        ...
        workspace.registerButtonCallback('CREATE_NUMBER_LIST', () => {
            Blockly.Variables.createVariableButtonHandler(workspace, createListButtonHandler('create_list_number_block'), 'List Number');
        });
        ...
        workspace.registerButtonCallback('CREATE_STRING_LIST', () => {
            Blockly.Variables.createVariableButtonHandler(workspace, createListButtonHandler('create_list_string_block'), 'List String');
        });
        ...
        workspace.registerButtonCallback('CREATE_BOOLEAN_LIST', () => {
            Blockly.Variables.createVariableButtonHandler(workspace, createListButtonHandler('create_list_boolean_block'), 'List Boolean');
        });
        ...
        workspace.registerButtonCallback('CREATE_COLOUR_LIST', () => {
            Blockly.Variables.createVariableButtonHandler(workspace, createListButtonHandler('create_list_colour_block'), 'List Colour');
        });
        ...
        if (numberListVariables.length > 0) {
            const blockNumberListSetText = '<xml>' +
                '<block type="set_number_list_block" gap="24">' +
                xmlSerializer.serializeToString(Blockly.Variables.generateVariableFieldDom(numberListVariables[0])) +
        ...
        if (stringListVariables.length > 0) {
            const blockStringListSetText = '<xml>' +
                '<block type="set_string_list_block" gap="24">' +
                xmlSerializer.serializeToString(Blockly.Variables.generateVariableFieldDom(stringListVariables[0])) +
            ...
            const blockTextGetListText = '<xml>' +
        ...
        if (booleanListVariables.length > 0) {
            const blockBooleanListSetText = '<xml>' +
                '<block type="set_boolean_list_block" gap="24">' +
                xmlSerializer.serializeToString(Blockly.Variables.generateVariableFieldDom(booleanListVariables[0])) +
            ...
            const blockTextGetListBoolean = '<xml>' +
        ...
        if (colourListVariables.length > 0) {
            const blockColourListSetText = '<xml>' +
                '<block type="set_colour_list_block" gap="24">' +
                xmlSerializer.serializeToString(Blockly.Variables.generateVariableFieldDom(colourListVariables[0])) +
            ...
            const blockTextGetListColor = '<xml>' +
...
const createListButtonHandler = (blockType) => {
    return (variableName) => {
