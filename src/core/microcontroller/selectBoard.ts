...
import microbit from "../../microcontrollers/microbit/profile";

export const getBoard = (type: MicroControllerType) => {
  return boardProfiles[type] || boardProfiles[MicroControllerType.ARDUINO_UNO];
};

export const getBoardFamily = (
  type: MicroControllerType,
): MicroControllerFamily => {
  switch (type) {
    case MicroControllerType.ARDUINO_MEGA:
    case MicroControllerType.ARDUINO_UNO:
      return MicroControllerFamily.ARDUINO;
    case MicroControllerType.MICROBIT:
      return MicroControllerFamily.MICROBIT;
  }
};
