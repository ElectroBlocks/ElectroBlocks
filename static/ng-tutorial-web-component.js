var app = (function () {
    ...
    ********************************************** */
    ...
    // (243:10) {#each lesson.steps as step, index}
    ...
    function create_if_block_1$1(ctx) {
    	...
    	let current;
    	let if_block0 = /*currentStep*/ ctx[6].step && /*currentStep*/ ctx[6].contentType !== "youtube" && create_if_block_7(ctx);
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (/*currentStep*/ ctx[6].step && /*currentStep*/ ctx[6].contentType !== "youtube") {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);
    				} else {
    ...
    // (250:6) {#if currentStep.step && currentStep.contentType !== 'youtube'}
    ...
    // (253:6) {#if currentStep.contentType === 'youtube'}
    ...
    // (264:6) {#if currentStep.contentType == 'code'}
    ...
    // (275:6) {#if currentStep.contentType === 'picture'}
    ...
    // (284:6) {#if currentStep.description}
    ...
    // (290:6) {#if lesson.steps.length > 1}
